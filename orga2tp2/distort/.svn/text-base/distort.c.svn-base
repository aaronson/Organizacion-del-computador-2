...
extern void asm_rubber_dynamics(int mousex, int mousey, int spcount, MASS* massy, SPRING* springy);
extern void asm_updateStates(int mousex, int mousey, int grab2, MASS* massy);
...
void display_init()
{
  ...
  glutAddMenuEntry("Rubber C", 1);
  glutAddMenuEntry("Rubber SSE", 2);
